...
<!-- 			<input type="button" value="Towers Table" -->
<!-- 				   onclick="window.location.href='towersList'; return false;" -->
<!-- 				   class="add-button"/>	 -->
...
<html lang="en">
  <head>
    <meta http-equiv="Content-Type" content="text/css; text/javascript; charset=UTF-8">
    ...
    <link type="text/css" href="${pageContext.request.contextPath}/resources/css/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
     <!-- Bootstrap -->
    <link type="text/css" href="${pageContext.request.contextPath}/resources/css/vendors/bootstrap/dist/css/bootstrap.css" rel="stylesheet">
    <!-- Font Awesome -->
    ...
    <link type="text/css" href="${pageContext.request.contextPath}/resources/css/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link type="text/css" href="${pageContext.request.contextPath}/resources/css/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link type="text/css" href="${pageContext.request.contextPath}/resources/css/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    ...
    <!-- FastClick -->
    <script type="text/javascript" src="<c:url value="/resources/js/fastclick.js"/>"></script>
    <!-- NProgress -->
    <script type="text/javascript" src="<c:url value="/resources/js/nprogress.js"/>"></script>
    <!-- Chart.js -->
    <script type="text/javascript" src="<c:url value="/resources/js/Chart.min.js"/>"></script>
    <!-- gauge.js -->
    <script type="text/javascript" src="<c:url value="/resources/js/gauge.min.js"/>"></script>
    <!-- bootstrap-progressbar -->
    <script type="text/javascript" src="<c:url value="/resources/js/bootstrap-progressbar.min.js"/>"></script>
    <!-- iCheck -->
    <script type="text/javascript" src="<c:url value="/resources/js/icheck.min.js"/>"></script>
    <!-- Skycons -->
    <script type="text/javascript" src="<c:url value="/resources/js/skycons.js"/>"></script>
    <!-- Flot -->
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.pie.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.time.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.stack.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.resize.js"/>"></script>
    <!-- Flot plugins -->
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.orderBars.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.flot.spline.min.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/curvedLines.js"/>"></script>
    <!-- DateJS -->
    <script type="text/javascript" src="<c:url value="/resources/js/date.js"/>"></script>
    <!-- JQVMap -->
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.vmap.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.vmap.world.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.vmap.sampledata.js"/>"></script>
    <!-- bootstrap-daterangepicker -->
...
<!--                   <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
        ...
        <footer>
          <div class="pull-right">
            TowerZoom (c)2018 - Alex Ignachuck - All Rights Reserved
            </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
